...
# CGO settings (if needed)
CGO_FLAGS=CGO_ENABLED=1 CGO_LDFLAGS="-L./unicorn/instdir/lib" CGO_CFLAGS="-I./unicorn/instrdir/include"
...
build: ## Build the application
	...
	@mkdir -p $(BUILD_DIR)
	$(CGO_FLAGS) $(GOBUILD) -o $(BUILD_DIR)/$(BINARY_NAME) $(MAIN_PATH)
